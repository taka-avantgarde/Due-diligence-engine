...
| **競合分析チャート** | Gartnerマジック・クアドラント、BCG成長・シェアマトリックス、McKinsey技術モート、GSリスク・リターン、3Dバブル — 6市場横断（グローバル、母国、米国、EMEA、SEA、LATAM） |
...
| 12 | **競合分析** | Gartnerマジック・クアドラント、BCGマトリックス、McKinsey技術モート、GSリスク・リターン、3Dバブル — 6市場横断 |
...
- [x] 競合分析チャート — コンサルファーム級5種類×6グローバル市場
- [x] PDF表紙に使用AIモデル表示
