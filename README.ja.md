...
| セクション | 内容 |
|-----------|------|
| **ビジネスサマリー** | 非エンジニアにも読める要約 + 投資評価バッジ |
| **6次元スコアリング** | 各次元1-10で評価。根拠・ビジネス説明・可能になること付き |
| **SWOT分析** | 強み・弱み・機会・脅威 — エビデンスベース、ビジネスアナロジー付き |
| **テクレベル評価** | 視覚的ゲージ（Lv.1-10）+ 平易な解説 |
| **将来性評価** | プロダクトビジョン + 1/3/5年予測（信頼度・マイルストーン付き） |
| **戦略アドバイス** | 即座のアクション、中期優先事項、長期ビジョン |
| **投資判断** | 推奨度 + リスク/アップサイド + 類似企業 |
| **レッドフラグ** | 深刻度別の問題点 + ビジネスインパクト |
| **用語集** | 全技術用語に非技術者向けの注釈 |
